    ...
    <main className="max-w-[1400px] mx-auto p-6 lg:p-10 space-y-32">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
         <div className="lg:col-span-8 space-y-16">
            <h2 className="text-6xl md:text-[120px] font-black uppercase tracking-tighter leading-[0.8] italic">Arquitectos <br/> de la verdad</h2>
            <p className="text-3xl md:text-5xl font-light text-zinc-500 dark:text-zinc-400 leading-[1.1] italic border-l-8 border-blue-600 pl-12 max-w-2xl">"Laboratorio independiente dedicado a la fiscalización ciudadana del poder nacional".</p>
         </div>
